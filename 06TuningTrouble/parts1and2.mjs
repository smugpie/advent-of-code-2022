...
file.on('close', () => {
    console.log('Part 1: position having 4 unique characters =', getUniqueCharacterSet(4))
    console.log('Part 2: position having 14 unique characters =', getUniqueCharacterSet(14))
})
